"""The Broyden-Fletcher-Goldfarb-Shanno minimization algorithm. Adapted from JAX's jax.scipy.optimize.minimize() implementation to support bound and custom gradients."""
